    ...
    <li
      ...
      onClick={(event) => {
        ...
        if (allLinks[0] === event.target) {
          allLinks[0].classList.add("link-selected")
          ...
          allLinks[1].classList.add("link-selected")
          downloadPDFFile()
          setTimeout(() => {
            allLinks[1].classList.remove("link-selected");
          }, 1000);
          ...
          allLinks[4].classList.add("link-selected")
          ...
          allLinks[5].classList.add("link-selected")
